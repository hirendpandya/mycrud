...
class AddRow extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($rowId) {
            ...
            if (!$rowData->getEntityId()) {
                $this->messageManager->addError(__('Bookinhg details no longer exist.'));
        ...
        $title = $rowId ? __('Edit Booking Details ').$rowTitle : __('Add Booking Details');
    ...
    {
        return $this->_authorization->isAllowed('Ktpl_Grid::add_row');
    }
}
